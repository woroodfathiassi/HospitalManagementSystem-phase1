...
{
    /// <inheritdoc />
    public partial class createHMSDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Medications",
                columns: new[] { "MedicationId", "Name", "Price", "Quantity" },
                values: new object[,]
                {
                    { 10, "Aspirin", 9.99m, 1 },
                    { 20, "Paracetamol", 4.49m, 2 },
                    { 30, "Ibuprofen", 7.99m, 3 },
                    { 40, "Amoxicillin", 12.99m, 4 }
                });
